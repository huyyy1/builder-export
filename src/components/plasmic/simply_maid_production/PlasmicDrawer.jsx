...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: SXoMFrEaQNl4/css
      ...
      triggerSlot={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__ebm9E)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__qCUx)}
              >
                <div
                  className={classNames(
                    projectcss.all,
