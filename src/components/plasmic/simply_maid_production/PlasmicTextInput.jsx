...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: l-dOtwLtehPY/css
import SmPersonIcon from "./icons/PlasmicIcon__SmPerson"; // plasmic-import: 8pHRXVVZxu7o/icon
    ...
    >
      ...
      >
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <SmPersonIcon
                className={classNames(projectcss.all, sty.svg__rQVnv)}
                role={"img"}
              />
            ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__c2M0Q)}
              role={"img"}
            />
          ),
...
const PlasmicDescendants = {
  root: ["root", "startIconContainer", "freeBox", "input", "endIconContainer"],
  startIconContainer: ["startIconContainer", "freeBox"],
  freeBox: ["freeBox"],
  input: ["input"],
